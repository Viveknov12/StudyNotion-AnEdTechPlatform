      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              <span> Made with ❤️ </span>
               {" "}
              <Link to='https://github.com/Viveknov12' target="__blank" className="text-white hover:underline mr-1"
              >
                Vivek Sharma
              </Link>
            </div>
          ...
          <div className="flex items-center">
            <a href="www.linkedin.com/in/vivek-sharma-b19983212" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://www.github.com/Viveknov12" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
            <a href="https://twitter.com/ShrmVivek" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImTwitter size={17} />
            </a>
          </div>
